...
export default function SkillsPage(): React.JSX.Element {
  ...
  return (
    <section
      id="skills"
      className="relative min-h-screen flex items-end justify-center px-4 lg:px-6 py-8 lg:py-12 pt-24 lg:pt-32 pb-16 lg:pb-20 overflow-hidden bg-gradient-to-b from-white via-gray-50/50 to-blue-50/30 dark:from-gray-950 dark:via-gray-900/50 dark:to-blue-950/20"
    >
      {/* Background Elements */}
      ...
      <div className="relative max-w-6xl mx-auto z-10 w-full mb-8 lg:mb-0">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-300 text-base max-w-xl mx-auto">
            Technologies que j'utilise pour créer des applications web modernes
            et performantes
          </p>
        </div>
            ...
            {categories.map((category) => {
              ...
              return (
                ...
                >
                  ...
                  <div
                    className={`px-1.5 py-0.5 rounded-full text-xs font-medium bg-gray-100/80 dark:bg-gray-800/80 text-gray-600 dark:text-gray-300 ${
                      isActive
                        ? "bg-blue-100/80 dark:bg-blue-950/50 text-blue-600 dark:text-blue-400"
                        : ""
                    }`}
                  >
                    {category.count}
